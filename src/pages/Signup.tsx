            ...
            <div className="max-w-6xl w-full grid md:grid-cols-2 gap-8 items-center relative z-10">
                ...
                <div className="w-full max-w-md mx-auto">
                    ...
                    <p className="mt-5 text-center text-sm text-[#a0abcc]">
                        ...
                        <Link to="/login" className="text-[#38bdf8] hover:text-blue-300 transition-colors font-medium">
                            Log in
                        </Link>
                    </p>

                    <p className="mt-5 text-center text-xs text-[#a0abcc] leading-relaxed px-2">
